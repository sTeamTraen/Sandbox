...
# Thanks to C?dric Batailler for help with the X-axis.
...
# 2019-11-11: trying two ways to avoid the issue whereby with min=3 and max=50,
#  user wants to type 22 but the 2 gets changed to 3.
...
# in version 0.16, we include the "bounce" code. The alternative is to not check the limits.
